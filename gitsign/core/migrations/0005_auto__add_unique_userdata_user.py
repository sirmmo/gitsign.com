...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UserData', fields ['user']
        db.create_unique(u'core_userdata', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserData', fields ['user']
        db.delete_unique(u'core_userdata', ['user_id'])
