...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'RS', fields ['repo', 'sign']
        db.create_unique(u'core_rs', ['repo_id', 'sign_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'RS', fields ['repo', 'sign']
        db.delete_unique(u'core_rs', ['repo_id', 'sign_id'])
