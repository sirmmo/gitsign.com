...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserData.name'
        db.alter_column(u'core_userdata', 'name', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'UserData.name'
        db.alter_column(u'core_userdata', 'name', self.gf('django.db.models.fields.TextField')(default=''))
    ...
    models = {
        ...
        u'core.repo': {
            'Meta': {'ordering': "['name']", 'object_name': 'Repo'},
        ...
        u'core.rs': {
            'Meta': {'unique_together': "(['repo', 'sign'],)", 'object_name': 'RS'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'core.sign': {
            'Meta': {'ordering': "['name']", 'object_name': 'Sign'},
        ...
        u'core.userdata': {
            ...
            'avatar': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '200'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
